        ...
        <form onSubmit={handleLogin} className="space-y-5 bg-transparent">
          <div>
            ...
            <div className="relative mt-2">
              <Input
                ...
                className="pl-10 bg-body border border-[--border] text-white"
                disabled={isLoading}
              />
          ...
          <div>
            ...
            <div className="relative mt-2">
              <Input
                ...
                className="pl-10 pr-10 bg-body border border-[--border] text-white"
                disabled={isLoading}
              />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-4 h-4 rounded border-[--border] bg-body text-orange-600 focus:ring-orange-600"
            />
